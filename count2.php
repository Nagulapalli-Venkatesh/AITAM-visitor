...
<body style="background-color: #EEEEEE;font-family: sans-serif;overflow: auto;">
	<header id="header1"><img id="logo" src="aitam2.jpg">
		<h1>AITAM VISITOR</h1>
		<ul style="margin-left:74%; ">
			<li><a href="home.php">Dashbord</a></li>
			<li><a href="http://aitamsac.in/">About us</a></li>
			<li><a href="logout.php">Logout</a></li>
		</ul>
	</header>
	<center><h1 id="vis" style="margin-top: 8%;">Visitors in the recent Year</h1></center>
	<center>
	...
	<ul class="pagination" style="margin-left: 40%;margin-top: 3%;">
<?php if($page_no > 1){
