...
<tr>
	...
	<td>&nbsp: </td>
	<td class="enter"><input type="text" name="visitor_name" placeholder=""></td>
</tr>
<tr>
...
<tr style="display: none" name="faculty" id="facultys">
	...
	<td class="enter" style="position:relative;left: 242px"><input type="text" placeholder="" name="faculty"></td>
</tr>

<tr>
	<td><label name="place">Visiter's Hometown</label>
	<td>&nbsp:</td>
	<td class="enter"><input type="textarea" name="place" placeholder=""></td>
</tr>
<tr>
	<td><label name="reason">Reason to visit</label></td>
	<td>&nbsp:</td>
	<td class="enter"> <input type="textarea" name="reason" placeholder="" id="box"></td>
</tr>

<tr>
	<td><label name="reason">Contact Number</label></td>
	<td>&nbsp:</td>
	<td class="enter"> <input type="text" name="contact" placeholder="" id="box"></td>
